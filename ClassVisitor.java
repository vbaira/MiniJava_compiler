...
/*
First Visitor.
Visit classDeclaration/classExtendsDeclaration nodes and fill main's classMap
and inheritanceMap with class names
*/
public class ClassVisitor extends GJDepthFirst< String,String>{


	/*create main's global classmap*/
	public ClassVisitor(){
		Main.classMap = new LinkedHashMap<String,SymbolMap>();
		Main.inheritanceMap = new LinkedHashMap<String,String>();
	}
	...
	*/
	/*if class is already declared throw error. 
	  If not check whether its parent is declared above as it should*/
