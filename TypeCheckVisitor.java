...
/*
Third and last visitor.
Typechecks statements and Expressions inside methods
*/
public class TypeCheckVisitor extends GJDepthFirst< String,String>{
	...
	*/
	public String visit(AssignmentStatement n, String argu) {
		...
		if ( lvalue_type.equals("int[]") || lvalue_type.equals("boolean") || lvalue_type.equals("int") ){
		...
		if (!lvalue_type.equals(rvalue_type)){
			if ( rvalue_type.equals("int[]") || rvalue_type.equals("boolean") || rvalue_type.equals("int") ){
				throw new RuntimeException("Incompatible type assignment.Symbol "+id+" is not of type "+rvalue_type+"::"+lvalue_type+"="+rvalue_type+" ( @->"+currentClass.getClassName()+"->"+currentMethod.getName()+"() )");
			}
	...
	*/
	public String visit(IfStatement n, String argu) {
		...
		if (!condition_type.equals("boolean")){
			throw new RuntimeException("Incompatible type inside if condition (must be boolean instead of "+condition_type +") ( @->"+currentClass.getClassName()+"->"+currentMethod.getName()+"() )");
		}
		n.f4.accept(this, argu);
		n.f6.accept(this, argu);
		return _ret;
	...
	*/
	public String visit(WhileStatement n, String argu) {
		...
		String condition_type=n.f2.accept(this, argu);
		if (!condition_type.equals("boolean")){
			throw new RuntimeException("Incompatible type inside if while (must be boolean instead of "+condition_type +") ( @->"+currentClass.getClassName()+"->"+currentMethod.getName()+"() )");
		}
		n.f4.accept(this, argu);
		return _ret;
	}
	...
	*/
	public String visit(MessageSend n, String argu) {
		...
		if ( object_type.equals("int") || object_type.equals("int[]") || object_type.equals("boolean") ){
	...
	*/
	public String visit(Identifier n, String argu) {
		...
		/*search for variable with name id and return type*/
			...
			Map<String,MiniJavaSymbol> method_map=currentMethod.getMethodMap();
			if (method_map.containsKey(id)){
				return method_map.get(id).getType();
			}
			/*If not found search class fields*/
			MiniJavaSymbol field=currentClass.get(id,"F_VAR","local");
			if ( field != null){
		...
		/*search for method with name id and return type+parameters*/
			...
			MiniJavaSymbol method=wanted_class.get(id,"METHOD","local");
			if ( method != null){
