...
public class IRvisitor extends GJDepthFirst<String,String>{
	...
	public IRvisitor(PrintWriter pw){
		...
		for ( Map.Entry<String,SymbolMap> cur_Class : Main.classMap.entrySet() ) {
			...
			List<MiniJavaSymbol> method_list=new ArrayList<MiniJavaSymbol>();//list of class's methods
			/*for each method in class create a substring to insert to the vtable declaration*/
			for (Map.Entry<String,List<MiniJavaSymbol>> sym_table_entry : sym_table.entrySet() ){
				String symbol_name=sym_table_entry.getKey();
				List<MiniJavaSymbol> symbol_list= sym_table_entry.getValue();
				for (MiniJavaSymbol symbol : symbol_list){
			...
			Collections.sort(method_list,MiniJavaSymbol.offsetComparator);
			int subst_counter=0;
			for (MiniJavaSymbol method : method_list){
	...
	public String visit(MainClass n, String argu) {
		...
		Map<String,MiniJavaSymbol> local_variable_map=currentMethod.getMethodMap();
		for(Map.Entry<String,MiniJavaSymbol> local_variable : local_variable_map.entrySet() ){
   ...
   /*********************************Exressions*****************************/
	...
	public String visit(MessageSend n, String argu) {
		...
		MiniJavaSymbol method=sym_table.get(method_name,"METHOD","local");
		if (method==null){
